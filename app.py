...
/* ── HERO ── */
.hero {
    background:linear-gradient(135deg,#0d4f4f 0%,#0a7272 50%,#20b2aa 100%);
...
.hero-title span { color:#20b2aa; }
.hero-sub { font-size:0.95rem; color:rgba(255,255,255,0.75); margin:0; line-height:1.6; }
.hero-info-box {
    background:rgba(32,178,170,0.15); border:1px solid rgba(32,178,170,0.35);
    border-left:3px solid #20b2aa; border-radius:10px;
    padding:12px 14px; margin-top:1rem;
}
.hero-info-title { font-size:0.78rem; font-weight:700; color:#20b2aa; margin-bottom:5px; }
.hero-info-text { font-size:0.8rem; color:rgba(255,255,255,0.82); line-height:1.6; }
...
.sec-label {
    ...
    font-size:0.8rem; font-weight:700; color:#20b2aa;
...
/* ── INFO BOX (debajo del botón) ── */
.info-box {
    background:#f0fafa; border:1px solid rgba(32,178,170,0.25);
    border-left:3px solid #20b2aa; border-radius:12px;
    padding:12px 14px; margin-top:1rem;
}
.info-box-title { font-size:0.78rem; font-weight:700; color:#20b2aa; margin-bottom:5px; }
.info-box-text { font-size:0.8rem; color:#4A4A4A; line-height:1.6; }
.info-box-link { font-size:0.78rem; color:#20b2aa; margin-top:6px; display:inline-block; }
...
with tab1:
    ...
    st.markdown("""
    <div class="info-box">
        <p class="info-box-title">📘 Información</p>
        <p class="info-box-text">El análisis elemental indica la composición química fundamental (C, H, N, S) de la biomasa.
        Estos datos son clave para evaluar su calidad energética y su comportamiento en procesos termoquímicos
        como gasificación, pirólisis y combustión.</p>
        <span class="info-box-link">Ver guía completa →</span>
    </div>
    """, unsafe_allow_html=True)
        ...
        for i in range(len(df_res)):
            ...
            with left_col:
                ...
                st.markdown(
                    ...
                    unsafe_allow_html=True)
                st.plotly_chart(chart_barras(row), use_container_width=True, key=f"chart_muestra_{i}")
