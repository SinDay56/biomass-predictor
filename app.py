...
/* ── HEADER ── */
.app-header {
    background: linear-gradient(135deg, #1a7a3c 0%, #22963f 60%, #2ab54a 100%);
    padding: 1.1rem 2rem;
...
.header-sub { font-size:0.78rem; color:rgba(255,255,255,0.8); margin:0 !important; }
...
.card-title {
    ...
    color:#1a5c9a !important; margin:0 0 1.1rem 0 !important;
    padding-bottom:0.7rem; border-bottom:2px solid #f0f4f8;
}

/* ── Tabla de ingreso de datos ── */
.col-header {
    font-size:0.72rem; font-weight:700; color:#1a5c9a;
    text-transform:uppercase; letter-spacing:0.06em;
    text-align:center; padding-bottom:4px;
}
.col-range {
    font-size:0.6rem; color:#9ca3af;
    font-family:'Fira Code',monospace; text-align:center; margin-bottom:6px;
}
.sample-label {
    font-size:0.78rem; font-weight:700; color:#1a7a3c;
    font-family:'Fira Code',monospace; padding:6px 0 2px;
}
.oor-hint {
...
.cluster-pill {
    ...
    background:linear-gradient(135deg,#1a7a3c,#2ab54a);
    color:#fff; border-radius:8px; padding:5px 14px;
    font-size:0.8rem; font-weight:700; letter-spacing:0.02em;
    box-shadow:0 3px 10px rgba(26,122,60,0.25);
}

/* ── Badges elementales ── */
.elem-row-wrap { display:flex; gap:7px; margin-top:0.5rem; }
.ebadge {
    flex:1; border:1.5px solid; border-radius:9px;
    padding:8px 4px; text-align:center;
}
.eb-sym { font-size:0.9rem; font-weight:800; line-height:1; }
.eb-pct { font-size:0.78rem; font-weight:600; margin-top:2px;
          font-family:'Fira Code',monospace; }
.e-C { border-color:#3b82f6; color:#1d4ed8; background:#eff6ff; }
.e-H { border-color:#22c55e; color:#15803d; background:#f0fdf4; }
.e-O { border-color:#0ea5e9; color:#0369a1; background:#f0f9ff; }
.e-N { border-color:#f97316; color:#c2410c; background:#fff7ed; }
.e-S { border-color:#84cc16; color:#3f6212; background:#f7fee7; }
...
.res-val { color:#111827; font-family:'Fira Code',monospace;
           font-size:0.88rem; font-weight:600; }
.rc{color:#1d4ed8;} .rh{color:#15803d;} .ro{color:#0369a1;}
.rn{color:#c2410c;} .rs{color:#3f6212;}
...
/* ── BOTONES ── */
.stButton>button {
    background:linear-gradient(135deg,#1a5c9a,#1d6fb5) !important;
    color:#fff !important; border:none !important; border-radius:9px !important;
    font-family:'Inter',sans-serif !important; font-size:0.9rem !important;
    font-weight:700 !important; padding:0.62rem 1rem !important;
    width:100% !important; letter-spacing:0.02em !important;
    box-shadow:0 4px 12px rgba(26,92,154,0.25) !important;
    transition:all 0.2s !important;
}
.stButton>button:hover {
    background:linear-gradient(135deg,#1d6fb5,#2480cc) !important;
...
[data-testid="stNumberInput"] input:focus {
    ...
    box-shadow:0 0 0 3px rgba(26,92,154,0.1) !important;
    background:#fff !important;
}
[data-testid="stNumberInput"] button {
    background:#f1f5f9 !important; border:1px solid #e2e8f0 !important; color:#374151 !important;
}
.stNumberInput label { color:#374151 !important; font-size:0.78rem !important; font-weight:600 !important; }

/* ── Tabs ── */
[data-testid="stTabs"] [data-baseweb="tab-list"] {
    background:#ffffff !important; border-radius:10px !important;
    padding:4px !important; gap:3px !important;
    box-shadow:0 1px 4px rgba(0,0,0,0.06) !important; margin-bottom:1rem !important;
}
...
[data-testid="stTabs"] [aria-selected="true"] {
    background:linear-gradient(135deg,#1a7a3c,#22963f) !important; color:#fff !important;
}

/* ── Sidebar ── */
[data-testid="stSidebar"] { background:#1a3a6a !important; }
[data-testid="stSidebar"] * { color:#7ab0e0 !important; }
[data-testid="stTextInput"] input {
    background:#0f2448 !important; border:1px solid rgba(255,255,255,0.1) !important;
    border-radius:7px !important; color:#c0d8f0 !important;
    font-family:'Fira Code',monospace !important; font-size:0.74rem !important;
}
.stTextInput label { color:#4a7aaa !important; font-size:0.74rem !important; }
[data-testid="stFileUploader"] {
    background:rgba(26,92,154,0.04) !important;
    border:1.5px dashed rgba(26,92,154,0.28) !important; border-radius:12px !important;
}
[data-testid="stDownloadButton"]>button {
    background:#fff !important; border:1.5px solid #1a5c9a !important;
    color:#1a5c9a !important; font-weight:700 !important;
...
/* alertas */
.al { border-radius:9px; padding:0.65rem 1rem; margin:0.5rem 0;
...
.a-info { background:#eff6ff; border-color:#3b82f6; color:#1e40af; }
</style>
...
<div class="app-header">
    ...
    <div>
        ...
        <p class="header-sub">Machine Learning Tool</p>
    </div>
</div>
""", unsafe_allow_html=True)
