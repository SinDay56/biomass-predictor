...
.stApp::before {
    ...
    background-image:
        ...
        radial-gradient(circle at 40% 40%, rgba(110, 231, 183, 0.08) 0%, transparent 30%),
        radial-gradient(circle at 60% 60%, rgba(167, 243, 208, 0.1) 0%, transparent 40%);
    pointer-events: none;
    z-index: 0;
}
...
.card {
    ...
    padding: 2rem 2.2rem;
    box-shadow: 
        0 10px 40px rgba(6,78,59,0.08),
        0 2px 10px rgba(6,78,59,0.04),
...
[data-testid="stNumberInput"] input:focus {
    ...
    box-shadow: 
        ...
        0 4px 15px rgba(6,78,59,0.1) !important;
...
[data-testid="stDownloadButton"] > button:hover {
    ...
    box-shadow: 0 6px 20px rgba(6,78,59,0.2) !important;
}
...
.result-card {
    ...
    border-radius: 20px;
    padding: 1.5rem;
    box-shadow: 0 6px 25px rgba(6,78,59,0.08);
...
with st.sidebar:
    ...
    <div style="text-align:center; padding:1.5rem 0 2rem;">
        ...
        <div style="font-family:'Outfit',sans-serif; font-size:1.3rem;
             color:#34d399; font-weight:800; margin-top:10px;">BiomassIQ</div>
        <div style="font-size:0.7rem; color:#065f46; margin-top:4px;
...
def chart_muestra(row, label):
    ...
    fig.update_layout(
        ...
        yaxis=dict(
            gridcolor='rgba(167,243,208,0.5)', 
            zeroline=False,
            ticksuffix='%', 
    ...
    if ejecutar:
        ...
        for i, step in enumerate(steps):
            status_text.markdown(
                ...
                f'<div class="progress-icon">{'🔄' if i < 3 else '✅'}</div>'
